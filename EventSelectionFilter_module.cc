...
private:
    ...
    float _op_pe_veto_max;
    art::InputTag _pot_prod_data;
    art::InputTag _pot_prod_mc;

    Long64_t _n_beam_gates_sr = 0;
    Long64_t _n_ext_gates_sr  = 0;
    double _pot_per_gate_sr   = -1.0;
