...
bool KPlusSignatureIntegrity::filter(const art::Event &e, const Signature& sig, const Type& type, common::PandoraView view)
{
    if(type != signature::SignatureChargedKaon) 
        return true;
