...
bool ChargedSigmaSignatureIntegrity::filter(const art::Event &e, const Signature& sig, const Type& type, common::PandoraView view)
{
    if(type != SignatureChargedSigma) return true;
