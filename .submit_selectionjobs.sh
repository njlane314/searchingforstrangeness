...
project.py --xml numi_fhc_workflow.xml --stage reweight_numi_fhc_run1_beam --check
project.py --xml numi_fhc_workflow.xml --stage reweight_numi_fhc_run1_strangeness --check
