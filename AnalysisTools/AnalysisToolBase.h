...
public:
    ...
    virtual void analyzeEvent(art::Event const& e, bool _is_data) = 0;

    virtual void analyzeSlice(art::Event const& e, std::vector<common::ProxyPfpElem_t>& slice_pfp_v, bool _is_data, bool selected) = 0;
