...
private:
    ...
    BuildContext const& ctx)
  {
    ...
    switch (view) {
      case geo::kU: pandora_view = common::TPC_VIEW_U; break;
      case geo::kV: pandora_view = common::TPC_VIEW_V; break;
      case geo::kW:
      case geo::kY: pandora_view = common::TPC_VIEW_W; break;
      default:
        throw cet::exception("ImageProduction")
          << "Unsupported geo::View_t: " << static_cast<int>(view);
    }

    TVector3 const proj = common::ProjectToWireView(static_cast<float>(wire_center.X()),
