...
namespace common
{
   ...
   */
  float GetTrackRMSDeflection(const common::ProxyCaloElem_t& trk,
            const float dmax) {
   ...
   */
  void GetMoliereRadius(const common::ProxyPfpElem_t pfp_pxy,
   ...
   * @input shower proxy  : track being provided as input
   */
  void GetMoliereRadiusMergedShowers(const common::ProxyPfpElem_t pfp_pxy, const common::ProxyPfpElem_t pfp2_pxy,
      float& medangle, float& rmsangle) {
