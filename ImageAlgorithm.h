...
namespace analysis
{
    ...
    public:
        ...
        TruthPrimaryLabel getTruthPrimaryLabel(int pdg) const {
            ...
            if (pdg == 22) return TruthPrimaryLabel::Photon;
            if (pdg == 2112) return TruthPrimaryLabel::Neutron;
            ...
            if (pdg == 3222 || pdg == 3112) return TruthPrimaryLabel::ChargedSigma;
            if (pdg == 3212) return TruthPrimaryLabel::NeutralSigma;
